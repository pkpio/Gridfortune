...
echo("<script> top.location.href='http://apps.facebook.com/spatchaker/profile_edit_new.php'</script>");
...
<br />
<h2 class="centering"><?php echo $name . "'s Public Profile"; ?><sup><a href="http://apps.facebook.com/miki-mona/edit_profile.php" class="edit" target="_top">&nbsp;&nbsp;Edit</a></sup></h2>
...
<div class="box">
<table>
<span class="tiny">Sports <?php echo $name; ?> play</span>
<tr>
...
<tr><td colspan="2"><span class="tiny">P.S: Numbers shown in bracks are <?php echo $name; ?>'s level in the corresponding sport</span></td></tr>
</table>
